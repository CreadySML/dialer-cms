...
export function IconBrand(props) {
  return (
    <svg viewBox="0 0 32 32" fill="none" {...props}>
      ...
      <path d="M21 18.5v2.4c0 .6-.55 1.1-1.2 1.05-7-.6-12.6-6.2-13.2-13.2C6.55 8.05 7.05 7.5 7.65 7.5h2.4c.55 0 1 .4 1.05.95.1 1.2.4 2.35.85 3.4.15.35.05.75-.2 1L10.55 14a13 13 0 0 0 5.65 5.65l1.15-1.15c.25-.25.65-.35 1-.2 1.05.45 2.2.75 3.4.85.55.05.95.5.95 1.05z" fill="white"/>
      <defs>
